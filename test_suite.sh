...
run CHECK_JDK_VERSION='1.8.0_151' CHECK_JDK_ROOT_DIR='jdk8' JDK_VERSION_MAJOR='8' ./tests.sh || test_failure
...
run CHECK_JDK_VERSION='1.8.0_151' CHECK_JDK_ROOT_DIR='jdk8' JVMW_FILE='jvmw.8_a.properties' ./tests.sh || test_failure
run CHECK_JDK_VERSION='1.8.0_151' CHECK_JDK_ROOT_DIR='jdk8' JVMW_FILE='jvmw.8_b.properties' ./tests.sh || test_failure
run CHECK_JDK_VERSION='1.8.0_152' CHECK_JDK_ROOT_DIR='jdk8u152' JVMW_FILE='jvmw.8u152.properties' ./tests.sh || test_failure
...
run CHECK_JDK_VERSION='9.0.1' CHECK_JDK_ROOT_DIR='jdk9' ./tests.sh || test_failure
run CHECK_JDK_VERSION='9.0.1' CHECK_JDK_ROOT_DIR='jdk9' JDK_VERSION_MAJOR='9' ./tests.sh || test_failure
run CHECK_JDK_VERSION='9.0.1' CHECK_JDK_ROOT_DIR='jdk9' JVMW_FILE='jvmw.9.properties' ./tests.sh || test_failure
run CHECK_JDK_VERSION='9.0.1' CHECK_JDK_ROOT_DIR='jdk9u152' JVMW_FILE='incorrect.jvmw.9u152.properties' ./tests.sh 2>/dev/null && test_failure

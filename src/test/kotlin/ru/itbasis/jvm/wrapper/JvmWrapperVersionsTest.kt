...
//    @MethodSource("data")
    ...
    fun testDefaultWrapper(testVersion: TestVersion, temporaryFolder: TemporaryFolder) {
        val samplePropertiesFile = Paths.get("samples.properties", "${testVersion.jvmVendor}-${testVersion.jvmVersion}.properties").toFile().copyTo(temporaryFolder.createFile(JVMW_PROPERTY_FILE_NAME), true)
